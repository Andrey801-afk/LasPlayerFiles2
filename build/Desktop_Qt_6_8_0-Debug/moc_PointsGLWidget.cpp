...
struct qt_meta_stringdata_CLASSPointsGlWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPointsGlWidgetENDCLASS = QtMocHelpers::stringData(
    "PointsGlWidget",
    "changeZ",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPointsGlWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PointsGlWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPointsGlWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPointsGlWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPointsGlWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *PointsGlWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPointsGlWidgetENDCLASS.stringdata0))
